...
{
	NSDictionary *factoryDefaults = @{WCXMLFileKey: @"English.xml",
		WCFontNameKey: @"Helvetica-Bold",
		WCHighlightColourKey: [NSKeyedArchiver archivedDataWithRootObject:[NSColor colorWithCalibratedRed:1.0f green:1.0f blue:1.0f alpha:1.0]],
		WCForegroundColourKey: [NSKeyedArchiver archivedDataWithRootObject:[NSColor colorWithCalibratedRed:0.25f green:0.25f blue:0.25f alpha:1.0]],
		WCBackgroundColourKey: [NSKeyedArchiver archivedDataWithRootObject:[NSColor colorWithCalibratedRed:0.0f green:0.0f blue:0.0f alpha:1.0]],	
		WCLeadingKey: @0.0f,
		WCTrackingKey: @0.0f,
		WCJustificationKey:@(WCJustificationLeft),
		WCStyleKey:@(WCStyleLinear),
		WCLinearTranslateXKey: @0.0f,
		WCLinearTranslateYKey: @0.0f,
		WCLinearScaleKey: @1.0f,
        WCRotaryTranslateXKey: @0.0f,
		WCRotaryTranslateYKey: @0.0f,
        WCRotaryScaleKey: @0.8f,
        WCLinearMarginLeftKey: @50.0f,
        WCLinearMarginRightKey: @50.0f,
        WCLinearMarginTopKey: @50.0f,
        WCLinearMarginBottomKey: @50.0f,
        WCTransitionTimeKey: @60,
 		WCTransitionStyleKey: @(WCTransitionStyleSlow)};
...
// ____________________________________________________________________________________________________ transition time
...
// ____________________________________________________________________________________________________ transition style
